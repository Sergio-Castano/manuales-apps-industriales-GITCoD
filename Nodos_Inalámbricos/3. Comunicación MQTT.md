...
Después de realizar la instalación procederemos a hacer una prueba rápida de Node Red (Cliente MQTT), haciendo el siguiente flow: 
<img src="/Nodos_Inalámbricos/imgs/pruebanode.png" width="900px">

Y usando el mismo publicador de mosquitto deberíamos ver lo siguiente en el apartado de debug: 
<img src="/Nodos_Inalámbricos/imgs/mensajeprueba.png" width="900px">
