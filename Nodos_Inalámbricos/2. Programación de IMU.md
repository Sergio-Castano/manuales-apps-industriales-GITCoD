Elementos y Conexiones (FALTA)
   -
Para realizar la implementación de los sensores inerciales (IMU) se necesitará un ESP32, un microcontrolador con conectividad Wi-Fi y Bluetooth; **AGREGAR REFERENCIA DEL IMU**; cables de conexion y otros componentes; una protoboard/PCB para montar y conectar los componentes del circuito; y una batería para alimentar el sistema. 
