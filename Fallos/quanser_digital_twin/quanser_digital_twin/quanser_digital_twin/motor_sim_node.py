# motor_sim_node.py (discreto) — NUEVA VERSIÓN con topics separados
import rclpy
...
class MotorSimNode(Node):
    def __init__(self):
        ...
        # Topics cambiados para que no choque con el motor teórico
        self.sub = self.create_subscription(Float64, '/cmd_voltage_disc', self.cmd_callback, 10)
        self.pub = self.create_publisher(Float64, '/motor_speed_sim_disc', 10)
